import {M44, Quaternion, V3, V4} from '../math';

import type {GameObject} from './GameObject'

export type CalcTransform = (position: V3, rotation: Quaternion) => M44
...
export const rotationFirst: CalcTransform = ({x, y, z}, rotation) => {
...
export const positionFirst: CalcTransform = ({x, y, z}, rotation) => {
